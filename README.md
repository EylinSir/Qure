...
1. 在 [常规图标预览](https://github.com/EylinSir/Qure#%E6%95%88%E6%9E%9C%E5%9B%BE%E9%A2%84%E8%A7%88)、[归档图标预览](https://raw.githubusercontent.com/EylinSir/Qure/master/Other/Qure_Preview_Archived.png) 或 [IconSet 页面](https://github.com/EylinSir/Qure/tree/master/IconSet) 中找到需要的策略组图标并记下**图标名称**；<br>
2. 在 Quantumult X 的“配置文件-编辑”中找到[policy]下的策略组字段，并在该策略组的最后一个节点后方加上：<br>
`img-url=https://raw.githubusercontent.com/EylinSir/Qure/master/IconSet/图标名称.png`<br>
例如：<br>
`static=Hong Kong, 🇭🇰01, img-url=https://raw.githubusercontent.com/EylinSir/Qure/master/IconSet/Hong_Kong.png`<br>
...
2. 将**个人设定**的策略组名称 **同名的.png** 图标文件(.png图标文件可在 [IconSet 页面](https://github.com/EylinSir/Qure/tree/master/IconSet)根据个人需求自行下载)粘贴到 Images 文件夹内，重启 Quantumult X 即可见到效果。<br>
...
## 补充说明
1. 转载请注明出处，谢谢！<br>
2. 归档图标：图标默认不展示，但仍支持订阅；具体可查看 [归档图标预览](https://raw.githubusercontent.com/EylinSir/Qure/master/Other/Qure_Preview_Archived.png) 及归档图标名称；<br>
...
## 效果图预览
[查看大图](https://raw.githubusercontent.com/EylinSir/Qure/master/Other/Qure_Preview_All.png)<br>
![Image text](https://raw.githubusercontent.com/EylinSir/Qure/master/Other/Qure_Preview_All.png)

![Koolson's github stats](https://github-readme-stats.vercel.app/api?username=EylinSir&show_icons=true&theme=vue-dark)
